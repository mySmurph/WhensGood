					...
					<ul>
						<li>
							<label aria-label="Give your event a title for people to know what the event is for.">
								Event Title<br />
								<input class = "text_input full" type = "text" id = "event_name" name = "event_name" value = "<?php echo $title?>" />
							</label>
						</li>
						<li>
							<label aria-label = "Set the date range of when you would like your event to take place.">Event Date Range<br /></label>
							<input id = "event_date_range_start" name = "event_date_range_start" class="text_input half calendar" type="date" aria-label="event_date_range_start" placeholder = "mm/dd/yyy" value = "<?php echo $start ?>"/>
							<input id = "event_date_range_end" name = "event_date_range_end" class = "text_input half calendar" type = "date" aria-label="event_date_range_end" placeholder = "mm/dd/yyy" value = "<?php echo $end ?>"/>
						</li>
						<li>
							<label aria-label = "Let your guest know by what date they need to respond by.">RSVP Deadline<br /></label>
							<input id = "rsvp_deadline" name = "rsvp_deadline" class = "text_input threeQuarters calendar" type = "date" aria-label="rsvp_deadline" placeholder="mm/dd/yyy" value = "<?php echo $deadLine ?>"/>
						</li>
						<li>
							...
							<div class = "text_input full">
								<input type = "number" class="Duration_time" id = "hr" name = "hr" min="0" max="12"  value = "<?php echo $Duration[0] ?>"aria-label="Hours" />HR
								<input type = "number" class="Duration_time" id = "min" name = "min" min="0" max="59" step="15"  value = "<?php echo $Duration[1] ?>"aria-label="Minutes"/>MIN
							</div>
						</li>
						<li>
							<label aria-label="Enter your contact info.">
								Organizer's Email<br />
								<input class="text_input full" type="email" id="organizers_email" name = "organizers_email" value = "<?php echo $email ?>"/>
							</label>
						</li>
						<li>
							<label aria-label="Set a password so you can access the scheduler later">Event Password<br /></label>
							<input class="text_input full" type="password" id="event_password" name = "event_password" aria-label="password" />
						</li>
						<li>
