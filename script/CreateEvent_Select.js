// let domEventName = document.getElementById("event_title");
...
// domEventName.setAttribute("placeholder", "Event Title");
...
// function setFile(){
// 	domChooseFile.setAttribute("value", document.getElementById("cal_upload").value);
// }
